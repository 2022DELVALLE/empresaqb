        ...
        <div className="Footer__box1">
            ...
            <div className="Footer__box1-information">
                <div className="Footer__box1-information1">
                    ...
                    <p className="Footer__box1-paragraph">Lorem, ipsum dolor sit amet consectetur adipisicing elit.
                        Consectetur sint reprehenderit assumenda, consequuntur explicabo rem veritatis, rerum eos ipsum
                        recusandae non praesentium voluptatibus nesciunt laboriosam placeat totam temporibus! Alias,
                        praesentium?</p>
                </div>
                ...
                <div className="Footer__box1-Social2">
                    ...
                    <div className="Footer__box1-Social2-Contacto">
                        <div className="Footer__box1-Social2-Icon">
                            ...
                            <span><a href="">930 820 893</a></span>
                        </div>
                        <div className="Footer__box1-Social2-Icon">
