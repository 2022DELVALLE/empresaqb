                                    ...
                                    <div className="RedesSociales_Tiktok">
                                        <a href="https://www.tiktok.com/@empresaqb">
                                            <svg width="46" height="46" viewBox="0 0 46 46" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M44.25 13.1944V32.3056C44.25 35.4734 42.9916 38.5115 40.7516 40.7516C38.5115 42.9916 35.4734 44.25 32.3056 44.25H13.1944C10.0266 44.25 6.98846 42.9916 4.74845 40.7516C2.50843 38.5115 1.25 35.4734 1.25 32.3056V13.1944C1.25 10.0266 2.50843 6.98846 4.74845 4.74845C6.98846 2.50843 10.0266 1.25 13.1944 1.25H32.3056C35.4734 1.25 38.5115 2.50843 40.7516 4.74845C42.9916 6.98846 44.25 10.0266 44.25 13.1944Z" stroke="white" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" />
                                                <path d="M18.0305 22.8666C16.6016 22.8666 15.2047 23.2904 14.0165 24.0843C12.8284 24.8781 11.9024 26.0065 11.3555 27.3267C10.8087 28.6469 10.6656 30.0996 10.9444 31.5011C11.2231 32.9027 11.9113 34.19 12.9217 35.2005C13.9321 36.2109 15.2195 36.899 16.621 37.1778C18.0225 37.4566 19.4752 37.3135 20.7954 36.7667C22.1156 36.2198 23.244 35.2938 24.0379 34.1056C24.8318 32.9175 25.2555 31.5206 25.2555 30.0916V8.41663C26.0575 10.825 29.1089 15.6416 34.8889 15.6416" stroke="white" stroke-width="3.125" stroke-linecap="round" stroke-linejoin="round" />
                                            </svg>
                                        </a>
                                    </div>
                                </div>
